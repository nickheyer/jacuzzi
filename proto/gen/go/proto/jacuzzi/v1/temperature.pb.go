...
const file_proto_jacuzzi_v1_temperature_proto_rawDesc = "" +
	...
	"\x16GetCurrentTemperatures\x12).jacuzzi.v1.GetCurrentTemperaturesRequest\x1a*.jacuzzi.v1.GetCurrentTemperaturesResponseB\xb1\x01\n" +
	"\x0ecom.jacuzzi.v1B\x10TemperatureProtoP\x01ZDgithub.com/nickheyer/jacuzzi/proto/gen/go/proto/jacuzzi/v1;jacuzziv1\xa2\x02\x03JXX\xaa\x02\n" +
	"Jacuzzi.V1\xca\x02\n" +
